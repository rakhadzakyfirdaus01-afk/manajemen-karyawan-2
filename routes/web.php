...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::put('/cuti/{cuti}/setujui',
        [CutiController::class, 'setujui'])
        ->name('cuti.setujui');

    Route::put('/cuti/{cuti}/tolak',
        [CutiController::class, 'tolak'])
        ->name('cuti.tolak');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/cuti/create',
        [CutiController::class, 'create'])
        ->name('cuti.create');

    Route::post('/cuti',
        [CutiController::class, 'store'])
        ->name('cuti.store');
